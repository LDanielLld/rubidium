...
namespace ScaleMeterModel_ConsoleApp1
{
    public partial class ScaleMeterModel
    {
        public const string RetrainFilePath =  @"E:\repositorios\Rubidium_repositorios\rubidium\Escala_Clinica\ClassifierScaleMeter\ClassifierScaleMeter\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.3796001F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
